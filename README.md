...
| 테스트 ID | 날짜 | 테스트 항목 | 결과 |
|-----------|--------|------|------|-----|
| T-0001 | 2025-11-25 | 환경 및 설치 | SUCCESS |  |
| T-0002 | 2025-11-25 | 데이터 로더 테스트 | SUCCESS |  |
| T-0003 | 2025-11-25 | 임베딩/벡터스토어 테스트 | SUCCESS |  |
| T-0004 | 2025-11-25 | Retriever 테스트 | SUCCESS |  |
| T-0005 | 2025-11-25 | RAG 파이프라인 테스트 | SUCCESS |  |
| T-0006 | 2025-11-25 | 프론트엔드 테스트 | SUCCESS |  |
| T-0007 | 2025-11-25 | 성능/비기능 | SUCCESS |  |
---
